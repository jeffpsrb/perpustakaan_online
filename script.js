...
formAddingBook.addEventListener("submit", function (event) {
    event.preventDefault(); // Mencegah formulir dari submit dan halaman refresh
    ...
    // Validasi tahun negatif
    if (year < 0) {
        alert("Tahun tidak boleh negatif. Silakan masukkan tahun yang valid.");
        return;
    }
